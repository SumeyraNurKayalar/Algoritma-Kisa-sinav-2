...
/*Kodun çalýþmasý için ilk olarak açýk arttýrmaya katýlacak kiþi sayýsý girilir ve teker teker bu kiþilerin
ödeyeceði miktarlar girilir.Bu ödeme miktarlarý ve kiþilerin isimleri girildikten sonra program en sonunda örnek olarak
girilmiþ item cismini en çok ödeme yapan kiþiye satar ve bu ödeme miktarýný verir. Ayriyeten bunun
altýnda açýk arttýrmaya katýlmýþ tüm katýlýmcýlarýn adý ve ödeme bedelleri yazar.*/
